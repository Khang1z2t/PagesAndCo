    ...
    <section className="section-gap">
      <div className="page-shell space-y-8">
        <div className="max-w-2xl space-y-3">
          <p className="section-eyebrow">Shop by shelf</p>
          <h2 className="section-heading text-[var(--color-charcoal)]">
            Find your next reading mood.
          </h2>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {genres.map((genre) => (
            <Link
              ...
              className="group rounded-[1.5rem] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--color-gold)]"
            >
              <article
                className="relative min-h-40 overflow-hidden rounded-[1.5rem] p-6 text-white shadow-[var(--shadow-card)] transition duration-200 group-hover:-translate-y-1 group-hover:shadow-[var(--shadow-card-hover)]"
