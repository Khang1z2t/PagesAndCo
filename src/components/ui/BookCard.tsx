...
export function BookCard({ book }: BookCardProps) {
  return (
    ...
    >
      <article className="h-full rounded-md border border-black/15 bg-white p-3 shadow-[0_10px_26px_rgba(30,28,24,0.06)] transition duration-200 group-hover:-translate-y-1 group-hover:shadow-[var(--shadow-card-hover)]">
        <div
